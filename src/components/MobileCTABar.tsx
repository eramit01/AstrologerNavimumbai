...
export default function MobileCTABar() {
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 flex h-16 items-center border-t border-orange-200 bg-orange-50 shadow-[0_-4px_6px_-1px_rgba(249,115,22,0.1)] md:hidden">
            <Link
                href={`tel:${CONTACT_INFO.phone}`}
                className="flex flex-1 flex-col items-center justify-center gap-1 border-r border-orange-200 text-orange-900 hover:bg-orange-100/50 transition-colors"
            >
